...
VEHICLES['e61'] = {
    ...
    'compartments': [
        ...
        ("Comp 6 — Passenger Side Middle", [
            ...
            "PFD",
            "Mustang Suit",
            "250 ft Utility Rope (not a throw bag)",
            "Life Safety Ring",
...
VEHICLES['e62'] = {
    ...
    'compartments': [
        ...
        ("Comp 5 — Officer Side Rear", [
            ...
            "Mid: 100' Utility Rope",
            "Mid: Pig Drain Cover",
            "Mid: RASP Bag — 200' Search Rope, Strobe Light, Cable Cutters, Webbing",
            "Bottom: Red Bag (4 PFDs, 1 Throw Preserver)",
            "Bottom: W-Tool",
        ...
        ("Comp 6 — Officer Side Middle", [
            ...
            "PFD",
            "Mustang Suit",
            "75 ft Rope Throw Bag",
            "175 ft Utility Rope (not a throw bag)",
            "Life Safety Ring",
            "Strap w/3 Carabiners",
...
VEHICLES['u61'] = {
    ...
    'compartments': [
        ...
        ("Truck Bed — Tools", [
            ...
            "Measuring Wheel",
            "PPE Masks",
            "Suppressall FS2-MAX (aerosol fire suppression generator)",
            "Hydrant Wrench",
            "Blanket",
            "ABC Extinguisher",
        ]),
...
VEHICLES['bt62'] = {
    ...
    'compartments': [
        ("Front Seat", [
            "Handheld Radios — ×2 (charged, correct channel)",
            "Passport Velcro System",
            "DU-COMM Radio (Grey)",
        ...
        ("Glove Box", [
            ...
            "Brushtruck Pumping/Drafting Manual",
            "Spare Wire Harness",
            "Spare Tire Lock Key",
            "Ford Owner's Manual",
            "Bug Spray",
        ...
        ("Back Seat — Milk Crate", [
            "Maps",
            "Duct Tape",
            "Caution Tape",
            "Garbage Bags",
            "Pub Ed — Public Education Stickers",
            "Safety Vests — ×2",
            "Door Stop",
        ]),
        ("Back Seat — Yellow Hose Bag", [
            "50' of Small 1\" Hose (Garden Hose)",
            "Webbing Strap",
        ]),
        ("Rear of Vehicle — Water Supply", [
            "250-Gallon Water Tank (confirm full)",
            "200' of 1\" Hose on Hose Reel (inspect wind)",
            "Handle for Hose Reel",
            "Hard Suction Hose — 2× 12' (Black)",
            "Drafting Float Strainer",
            "Plastic Gas Tank (confirm full)",
            "2½\" Hose — 50'",
            "1½\" Hose — 150' (Cross Lay)",
            "Fog Nozzle",
            "Gas-Powered Pump — 2½\" Inlet / 1½\" Outlet (fuel & oil checked)",
        ]),
        ("Truck Bed Tools", [
            "Brush Paddles — ×5",
            "Pike Poles — ×3 (6')",
        ...
        ("Hydrant Bag", [
            ...
            "1\" Garden Hose",
            "Hydrant Wrench",
            "Small Spanner (1¾\" hose / gas shutoff)",
            "Large Spanner (5\" hose)",
            "Black Electrical Tape",
            "Steamer-to-Storz Connector",
